...
void replaceInDatacard(TString Signal,bool extra , bool UseToys = true, TString Plot= "")
    {
        ...
        TString DATACARDNAME = "datacard_template_600.txt";
        if (year == "2024"){ DATACARDNAME = "datacard_template_2024_600.txt";}
...
void RunAllGatherHistograms() {
    ...
    std::vector<TString> SignalSet;
             ...
             SignalSet={
                ...
                "RPV_"+YEARCor+"_smu600_neu185_ctau001","RPV_"+YEARCor+"_smu600_neu200_ctau001",
                "RPV_"+YEARCor+"_smu600_neu250_ctau001","RPV_"+YEARCor+"_smu600_neu300_ctau001",
                "RPV_"+YEARCor+"_smu600_neu400_ctau001","RPV_"+YEARCor+"_smu600_neu500_ctau001",
                "RPV_"+YEARCor+"_smu600_neu550_ctau001","RPV_"+YEARCor+"_smu600_neu580_ctau001",

                "RPV_"+YEARCor+"_smu600_neu185_ctau003","RPV_"+YEARCor+"_smu600_neu200_ctau003",
                "RPV_"+YEARCor+"_smu600_neu250_ctau003","RPV_"+YEARCor+"_smu600_neu300_ctau003",
                "RPV_"+YEARCor+"_smu600_neu400_ctau003","RPV_"+YEARCor+"_smu600_neu500_ctau003",
                "RPV_"+YEARCor+"_smu600_neu550_ctau003","RPV_"+YEARCor+"_smu600_neu580_ctau003",


                "RPV_"+YEARCor+"_smu600_neu185_ctau010","RPV_"+YEARCor+"_smu600_neu200_ctau010",
                "RPV_"+YEARCor+"_smu600_neu250_ctau010","RPV_"+YEARCor+"_smu600_neu300_ctau010",
                "RPV_"+YEARCor+"_smu600_neu400_ctau010","RPV_"+YEARCor+"_smu600_neu500_ctau010",
                "RPV_"+YEARCor+"_smu600_neu550_ctau010","RPV_"+YEARCor+"_smu600_neu580_ctau010",

                "RPV_"+YEARCor+"_smu600_neu185_ctau030","RPV_"+YEARCor+"_smu600_neu200_ctau030",
                "RPV_"+YEARCor+"_smu600_neu250_ctau030","RPV_"+YEARCor+"_smu600_neu300_ctau030",
                "RPV_"+YEARCor+"_smu600_neu400_ctau030","RPV_"+YEARCor+"_smu600_neu500_ctau030",
                "RPV_"+YEARCor+"_smu600_neu550_ctau030","RPV_"+YEARCor+"_smu600_neu580_ctau030",

                "RPV_"+YEARCor+"_smu600_neu185_ctau100","RPV_"+YEARCor+"_smu600_neu200_ctau100",
                "RPV_"+YEARCor+"_smu600_neu250_ctau100","RPV_"+YEARCor+"_smu600_neu300_ctau100",
                "RPV_"+YEARCor+"_smu600_neu400_ctau100","RPV_"+YEARCor+"_smu600_neu500_ctau100",
                "RPV_"+YEARCor+"_smu600_neu550_ctau100","RPV_"+YEARCor+"_smu600_neu580_ctau100",

                "RPV_"+YEARCor+"_smu600_neu185_ctau300","RPV_"+YEARCor+"_smu600_neu200_ctau300",
                "RPV_"+YEARCor+"_smu600_neu250_ctau300","RPV_"+YEARCor+"_smu600_neu300_ctau300",
                "RPV_"+YEARCor+"_smu600_neu400_ctau300","RPV_"+YEARCor+"_smu600_neu500_ctau300",
                "RPV_"+YEARCor+"_smu600_neu550_ctau300","RPV_"+YEARCor+"_smu600_neu580_ctau300",

                "RPV_"+YEARCor+"_smu600_neu185_ctau1000","RPV_"+YEARCor+"_smu600_neu200_ctau1000",
                "RPV_"+YEARCor+"_smu600_neu250_ctau1000","RPV_"+YEARCor+"_smu600_neu300_ctau1000",
                "RPV_"+YEARCor+"_smu600_neu400_ctau1000","RPV_"+YEARCor+"_smu600_neu500_ctau1000",
                "RPV_"+YEARCor+"_smu600_neu550_ctau1000","RPV_"+YEARCor+"_smu600_neu580_ctau1000"
    ...
    for (unsigned int l = 0 ; l < SignalSet.size() ; l++) // Create Combine repo for each benchmark
        {
            ...
            // !! 
            returnCode1 = gSystem->Exec("cp CombineDataCards_600.sh "+Directory);
            if (returnCode1 == 0) {
                std::cout << "cp CombineDataCards_600.sh executed successfully!" << std::endl; count++;   
            } else {
                std::cout << "cp CombineDataCards_600.sh failed with return code: " << returnCode1 << std::endl;
            }
        ...
        // // !! 
        returnCode1 = gSystem->Exec("cp RunCombineDatacards_600.sh "+ParentDirectory);
        if (returnCode1 == 0) {
            std::cout << "cp  RunCombineDatacards_600.sh  executed successfully!" << std::endl; countParent++;   
        } else {
            std::cout << "cp  RunCombineDatacards_600.sh  failed with return code: " << returnCode1 << std::endl;
        }
